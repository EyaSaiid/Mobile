...
public class ServiceUsers {
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
               ...
               // u.setDomaine(obj.get("domaine").toString());
                ...
                u.setImage_user(obj.get("image").toString());
  ...
  public Users verifer(String email, String password) {
        // Users user = null;
        String url = Statics.BASE_URL + "/users/verifier?email=" + email + "&password=" + password;
        req.setUrl(url);
        req.setPost(false);
...
public Users veriferemail(String email) {
        // Users user = null;
        String url = Statics.BASE_URL + "/users/verifier/email?email=" + email;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
...
public void sendEmail(String email, int code) {
        try {
            ...
            msg.setSubject("[Dma9] reinitialisation mot de passe ");
            ...
            st.connect("smtp.gmail.com", 465, "eyatest240@gmail.com", "eya123456");
...
public Users resetpassword(Users Resetuser) {
        // Users user = null;
        String url = Statics.BASE_URL + "/users/resetpassword?id=" + Resetuser.getId()+"&password="+Resetuser.getPassword() ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
...
public boolean addUser(Users u) {
        ...
        String url = Statics.BASE_URL + "/users/adduser?nom=" + u.getNom()
                + "&prenom=" + u.getPrenom() + "&sexe=" +u.getSexe()
                + "&tel=" + u.getNumero_tele()  + "&image=" + u.getImage_user()
                + "&date=" + u.getDate()  + "&email=" + u.getEmail() + "&password="+u.getPassword()+"";
...
public void sendEmail2(String email, int code) {
        try {
            ...
            msg.setRecipients(Message.RecipientType.TO, email);
            msg.setSubject("[Dma9] Creation Compte ");
            msg.setSentDate(new Date(System.currentTimeMillis()));
...
public Users updateuser(Users sessionuser) {
        // Users user = null;
        String url = Statics.BASE_URL + "/users/updateprofile?id=" + sessionuser.getId()+"&nom="+sessionuser.getNom()+"&prenom="+sessionuser.getPrenom() ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
